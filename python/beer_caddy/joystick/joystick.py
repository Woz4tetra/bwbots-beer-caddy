...
class Joystick:
    ...
    def __init__(self, button_mapping: RecursiveNamespace, axis_mapping: RecursiveNamespace):
        self.prev_msg: JoystickMessage = JoystickMessage()
        self.curr_msg: JoystickMessage = JoystickMessage()
    ...
    def set_msg(self, msg: JoystickMessage):
        if not self.prev_msg:
            self.prev_msg = msg
        else:
            self.prev_msg = JoystickMessage.from_msg(self.curr_msg)
        self.curr_msg = JoystickMessage.from_msg(msg)
