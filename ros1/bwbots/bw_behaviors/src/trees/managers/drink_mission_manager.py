...
class DrinkMissionManager:
    def __init__(self) -> None:
        ...
        self.mission_sub = rospy.Subscriber("add_mission", DrinkMission, self.callback, queue_size=5)
        self.mission_queue_pub = rospy.Publisher("missions", DrinkMissionArray, queue_size=5)
