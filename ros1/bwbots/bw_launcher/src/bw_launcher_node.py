...
from bw_launcher.srv import SetLaunch, SetLaunchResponse
from bw_launcher.srv import GetLaunch, GetLaunchResponse

from bw_tools.launch_manager import LaunchManager
from bw_tools.launch_manager import TopicListener


class BwLauncher:
    def __init__(self):
        self.node_name = "bw_launcher"
        rospy.init_node(
            self.node_name
        ...
        self.service_ns = rospy.get_param("~service_ns", "/bw")
