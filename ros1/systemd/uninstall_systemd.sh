...
echo "Running bwbots systemd service uninstall script"
...
rm ${SERVICE_ROOT_DIR}/${JETSON_CLOCKS_NAME}
...
systemctl stop ${JETSON_CLOCKS_NAME}

systemctl disable ${SERVICE_NAME}
systemctl disable ${LAUNCH_SERVICE_NAME}
systemctl disable ${JETSON_CLOCKS_NAME}

echo "bwbots systemd service uninstallation complete"
